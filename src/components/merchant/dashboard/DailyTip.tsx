  ...
  return (
    <div className="p-6 h-full flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center items-center text-center space-y-6">
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Guides et tutoriels</h3>
        ...
        <button
          ...
          className="px-6 py-3 bg-[#7fbd07] text-white rounded-xl font-medium hover:bg-[#6ba006] transition-colors"
        >
      ...
      {showTutorials && (
        <div className="mt-6 space-y-4 max-h-96 overflow-y-auto">
          <div className="p-3 bg-gradient-to-br from-[#c9eaad]/10 to-[#7ebd07]/10 rounded-xl border border-[#c9eaad]/20">
            <h4 className="font-semibold text-[#032313] mb-2 text-sm">Configuration initiale</h4>
            <iframe
          ...
          <div className="p-3 bg-gradient-to-br from-[#c9eaad]/10 to-[#7ebd07]/10 rounded-xl border border-[#c9eaad]/20">
            <h4 className="font-semibold text-[#032313] mb-2 text-sm">Gestion des offres</h4>
            <iframe
              className="w-full h-32 rounded-lg"
              src="https://www.youtube.com/embed/zoFnEF-A7kQ"
